   ...
   /* const testImage = document.getElementById('layer1');
    ...
    class Particle{
        ...
        draw(context){
            ...
            * this.spriteSize, this.spriteSize, this.spriteSize,
    ...
    class UI{
        ...
        draw(context){
            ...
            context.lineWidth = 3;
            context.strokeText('SCORE: ' + this.game.score, 20, 40);
            ...
            context.font = '20px ' + this.fontFamily;
            context.fillStyle = this.color; // Reset back for other UI
            context.strokeStyle = 'black';
            context.lineWidth = 3;
            context.strokeText('TIMER: ' + formattedTime, 20, 100);
